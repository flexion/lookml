view: qppar__prod__latest__transform_beneficiaries__beneficiaries_clean {
  sql_table_name: default.qppar__prod__latest__transform_beneficiaries__beneficiaries_clean ;;
  suggestions: no
