view: qppar__prod__latest__extract_inpatient_claims__inpatient_claims {
  sql_table_name: default.qppar__prod__latest__extract_inpatient_claims__inpatient_claims ;;
  suggestions: no
