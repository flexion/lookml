view: qppar__prod__latest__transform_inpatient_claims__inpatient_claims_clean {
  sql_table_name: default.qppar__prod__latest__transform_inpatient_claims__inpatient_claims_clean ;;
  suggestions: no
