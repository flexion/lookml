view: qppar__prod__latest__transform_carrier_claims__carrier_claims_clean {
  sql_table_name: default.qppar__prod__latest__transform_carrier_claims__carrier_claims_clean ;;
  suggestions: no
