view: qppar__prod__latest__extract_outpatient_claims__dropped_records {
  sql_table_name: default.qppar__prod__latest__extract_outpatient_claims__dropped_records ;;
  suggestions: no
