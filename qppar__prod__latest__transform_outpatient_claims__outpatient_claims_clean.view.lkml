view: qppar__prod__latest__transform_outpatient_claims__outpatient_claims_clean {
  sql_table_name: default.qppar__prod__latest__transform_outpatient_claims__outpatient_claims_clean ;;
  suggestions: no
