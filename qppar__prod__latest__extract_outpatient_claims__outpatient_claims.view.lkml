view: qppar__prod__latest__extract_outpatient_claims__outpatient_claims {
  sql_table_name: default.qppar__prod__latest__extract_outpatient_claims__outpatient_claims ;;
  suggestions: no
